...
description: A community-driven cybersecurity knowledge base built from first principles – 400+ notes, mind-maps, and cheat-sheets.
---

<style>
  /* Hide the default Quartz title and description that would appear above */
  .article-title,
  .content-meta {
  ...
  .premium-header h1 {
    ...
    background: linear-gradient(135deg, #f7b731, #f5a623, #f7971e);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    background-clip: text;
    text-shadow: 0 0 30px rgba(247, 183, 49, 0.15);
    line-height: 1.1;
  }
  ...
  @media (max-width: 640px) {
    ...
    .premium-header { padding: 1.8rem 1rem; }
  }
</style>

<div class="premium-header">
  <h1>Cybersecurity Handbook</h1>
  <!-- Optional description – delete the line below if you don't want it -->
  <p class="subtitle">A community-driven knowledge base built from first principles</p>
  <div class="badge">✦ 400+ notes · open source · always evolving</div>
</div>
